...
# @param group
# @param manage_pkg
# @param memcached_python_ensure
# @param memcached_python_pkgs
# @param memcached_enabled
# @param user
#
# === Authors
#
...
class graphite_web (
  ...
  $config_memcached_default_cache_duration = $::graphite_web::params::config_memcached_default_cache_duration,
  $config_memcached_hosts                  = $::graphite_web::params::config_memcached_hosts,
  ...
  $memcached_python_ensure                 = $::graphite_web::params::memcached_python_ensure,
  $memcached_python_pkgs                   = $::graphite_web::params::memcached_python_pkgs,
